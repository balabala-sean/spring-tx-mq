package com.balabala.spring.tx.dist.mybatis;
...
public class MybatisSqlSessionFactory {
    ...
    public MybatisSqlSessionFactory(DataSource dataSource){
        ...
        ClassPathResource[] classPathResources = new ClassPathResource[]{new ClassPathResource("com/balabala/spring/tx/dist/mapper/MqMessageMapper.xml")};
