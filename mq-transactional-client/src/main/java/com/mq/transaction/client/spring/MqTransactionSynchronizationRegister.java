...
public class MqTransactionSynchronizationRegister {
    ...
    public void registe(TransactionSynchronization transactionSynchronization){
        ...
        logger.info("registe {} to TransactionSynchronizationManager", transactionSynchronization.getClass().getSimpleName());
    }
